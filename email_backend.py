...
def get_email_service():
    ...
    supabase_url = "https://vzhnrxiridogwdkdqxnx.supabase.co" 
    supabase_key = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZ6aG5yeGlyaWRvZ3dka2RxeG54Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTQwMjU3NjYsImV4cCI6MjA2OTYwMTc2Nn0.iHhwhP9viiCiNMhx-jTGoxZtRHDzGOAnve1r6isMNtc"
...
if __name__ == "__main__":
    ...
    login_creds = {
        "email": "workace419@gmail.com",  # Replace with your Gmail
        "password": "zhyo wohh aapc irvm",  # Replace with App Password (no spaces)
